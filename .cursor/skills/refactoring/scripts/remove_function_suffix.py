...
def main():
    ...
    """
    # Get project root (script is at .cursor/skills/refactoring/scripts/)
    ...
    # Process in order: src/app → tests → other directories
    # NOTE: Adjust paths for your project structure (Angular: src/app, Python: src/backend)
    search_dirs = [
